package com.example.se1829_prm392_kindergartenms.DB;
...
public class SqlDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_FEEDBACK_DATE = "date";
    ...
    public Teacher getTeacherById(String teacherId) {
        ...
        Cursor cursor = db.rawQuery("SELECT teacherId, fullName, address, phone, dob FROM teachers WHERE teacherId = ?", new String[]{teacherId});

        if (cursor != null && cursor.moveToFirst()) {
            Teacher teacher = new Teacher(
                    cursor.getString(0),  // teacherId
    ...
    public boolean updateTeacher(Teacher teacher) {
        ...
        int rows = db.update("teachers", values, "teacherId = ?", new String[]{teacher.getTeacherId()});
        return rows > 0;
    }
